...
function createMenuItemElement(item) {
    return `
        <a href="memberProduct.php?id=${item.product_id}" class="menu-item" data-category="${item.category_id}" data-product-id="${item.product_id}">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelector('.filter-container').addEventListener('click', async (e) => {
        ...
        menuGrid.innerHTML = products.map(product => `
            <a href="memberProduct.php?id=${product.product_id}" class="menu-item" data-category="${product.category_id}">
                <div class="menu-item-image">
